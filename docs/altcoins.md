...
The first thing you need to do is create a wallet implementation that conforms to the wallet interface found [here](https://github.com/digitalrupee-project/wallet-interface).
...
which talks to bitcoind using the JSON-RPC interface. The code, found [here](https://github.com/digitalrupee-project/openbazaar-go/tree/master/bitcoin/bitcoind), could be
...
fluctuations. This functionality is provided by the a package implementing the [ExchangeRates](https://github.com/digitalrupee-project/openbazaar-go/blob/master/bitcoin/exchangerates.go) interface.
...
The wallet selection switch can be found [in openbazaard.go](https://github.com/digitalrupee-project/openbazaar-go/blob/master/openbazaard.go):
```go
